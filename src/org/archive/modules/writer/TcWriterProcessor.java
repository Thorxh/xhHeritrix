...
public class TcWriterProcessor extends Processor {
    ...
    private static final Logger logger =
        Logger.getLogger(TcWriterProcessor.class.getName());
...
//        recorder.setContentEncoding("utf-8");
    ...
    */
    private void writeToPath(RecordingInputStream recis, File dest)
        ...
        try {
            ...
            if(htmlSaver != null) {
//            	System.out.println("标题：" + htmlSaver.getTitle());
//            	System.out.println("正文：" + htmlSaver.getContent());
            	/**
            	 * 保存到文件
            	 */
            	bw = new BufferedWriter(new FileWriter(dest));
            	String out = "标题：" + htmlSaver.getTitle() + "\n正文：" + htmlSaver.getContent();
            	bw.write(out);
            	bw.flush();
            }
